...
** Si desea acceder a la API de gestión de inquilinos, introduzca el ID de cuenta de inquilino. +image:../media/sso_auth_python_script.png["Script de autenticación SSO"]
