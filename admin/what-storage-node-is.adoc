...
Puede utilizar la página Diagnósticos para obtener información adicional sobre el estado actual de la cuadrícula. Consulte link:../monitor/running-diagnostics.html.html["Ejecución de diagnósticos"].
