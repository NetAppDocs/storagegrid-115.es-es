...
summary: Cuando un cliente de S3 emite una solicitud POSTERIOR de restauración de objetos, se realiza una solicitud para restaurar un objeto del almacenamiento AWS Glacier en un Cloud Storage Pool. El servidor emite este mensaje si la transacción se realiza correctamente. 
---
